...
async fn main() -> std::io::Result<()> {
    ...
    let engine = match LsmEngine::new_from_config(&config, apexstore::storage::cache::GlobalBlockCache::new(64, 4096)) {
        Ok(engine) => engine,
        Err(e) => {
            ...
            return Err(io::Error::new(io::ErrorKind::InvalidData, e.to_string() as String));
        }
    };
